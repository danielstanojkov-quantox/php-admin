<ul class="nav nav-tabs my-3 mx-3">
    ...
    <?php if (isset($_GET['db_name'])) : ?>
        <li class="nav-item mr-3">
            <button class="nav-link bg-dark text-light" id="sql__tab--btn"><i class="fas fa-sticky-note"></i> SQL</button>
        </li>
    <?php endif; ?>
    <li class="nav-item mr-3">
    ...
    <li class="nav-item">
        <a class="nav-link bg-dark text-light" href="#"><i class="fas fa-download"></i></i> Export</a>
    </li>
</ul>